...
<main class="grid h-dvh w-full items-center justify-center dark:bg-slate-800">
	<div class="flex w-lg flex-col items-center gap-4 rounded-4xl min-h-60 dark:bg-slate-950 dark:text-white bg-slate-50 p-12 pt-10"> 
		<section class="flex w-full flex-col gap-y-4">
			<div class="relative">
				<h1 class="text-center mx-8 text-3xl font-bold">{@html card.expression}</h1>
